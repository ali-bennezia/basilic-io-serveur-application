...
//Implémentations
exports.arrayEqualsArray = (array1, array2) => Array.isArray(array1) &&
...
exports.sanitizeObject = (modelObject, object) => this.arrayEqualsArray(Object.getOwnPropertyNames(modelObject).sort(), Object.getOwnPropertyNames(object).sort());
...
exports.containsAllNecessarySigninData = (object) => !(!object || !this.containsUniqueUserData(object) || !object.motDePasse);
/*
...
*/
exports.containsOnlyGivenArrayElementsAsProperties = (object, propertyNames) => {
...
*/
exports.arrayContainsOnlyGivenArrayElementsAsProperties = (object, propertyNames) => {
...
exports.containsOnlyUpdatableUserData = (user) => this.containsOnlyGivenArrayElementsAsProperties(user, updatableUserData);
/*
...
*/
exports.overwriteAndAddObjectProperties = function (objectToOverwrite, propertiesObject) {
    let overwrittenObject = Object.assign({}, objectToOverwrite);
...
exports.sanitizeMediaAuthorizationObject = function (object) {
    ...
    if (object &&
        ...
        object.length <=
            parseInt((_a = process.env.MAX_TOKEN_MEDIA_AUTHORIZATION_AUTHENTIFICATION_REQUESTS) !== null && _a !== void 0 ? _a : 24)) {
...
exports.trimMediaAuthorizationObject = function (object) {
    ...
    let maxLength = parseInt((_a = process.env
        .MAX_TOKEN_MEDIA_AUTHORIZATION_AUTHENTIFICATION_REQUESTS_PER_REQUEST) !== null && _a !== void 0 ? _a : 24);
    return this.trimArray(object, maxLength);
};
//Vérifier si l'objet object est bien une chaine de charactères.
exports.isObjectString = (object) => object != null &&
    object != undefined &&
    object != false &&
...
exports.isObjectValidStringId = (object) => this.isObjectString(object) && mongoose.Types.ObjectId.isValid(object);
//Vérifier si l'objet object est bien une chaine de charactères indiquant un moment précis, un timestamp.
exports.isStringTimestamp = (object) => this.isObjectString(object) && new Date(object).getTime() > 0;
//Extraire les informations sommaire de profil d'un utilisateur à partir de son document et celui de ses paramètres.
exports.getUserSummaryProfileData = (user, userParams) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if ("photoProfil" in userParams && userParams.photoProfil)
        profileData.photoProfil = yield mediaUtils.getMediaLinkFromId(userParams.photoProfil.toString());
    if ("banniereProfil" in userParams && userParams.banniereProfil)
        profileData.banniereProfil = yield mediaUtils.getMediaLinkFromId(userParams.banniereProfil.toString());
