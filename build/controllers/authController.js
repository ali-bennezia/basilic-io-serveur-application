...
exports.refreshToken = function (req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            let payload = null;
            try {
                payload = yield authUtils.authentifySessionToken(req.body.token);
            }
            catch (err) { }
            if (!payload)
                return res.status(401).json("Unauthorized");
            let newSession = yield authUtils.generateUserIdSession(payload.userId);
...
*/
exports.authentifyToken = function (req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (!user)
                return res.status(400).json("Bad Request");
            if ("mediaAuthorizations" in req.body &&
                ...
                let trimedMediaAuths = objectUtils.trimMediaAuthorizationObject(req.body.mediaAuthorizations);
                for (let mediaLink of trimedMediaAuths) {
                    authData.mediaAuthorizations.push({
                        mediaLink: mediaLink,
                        authorization: yield mediaUtils.checkUserMediaAccessByUserId(mediaLink, payload.userId),
                    });
                }
            }
            return res.status(200).json(authData);
...
*/
exports.sendPasswordRecoveryKey = function (req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            //Sanitation des valeurs reçues.
            let md = "mode" in req.params ? parseInt(req.params.mode) : -1;
            if (!objectUtils.containsOnlyGivenArrayElementsAsProperties(req.body, [
                "nomUtilisateur",
                "numeroTelephone",
                "email",
            ]) ||
            ...
            let usr = yield userModel.model.findOne(identifier).exec();
            if (usr == null)
            ...
            if ("derniereDateDRM" in usr) {
                if ((currentTime - usr.derniereDateDRM) / 1000 <
...
*/
exports.authentifyPasswordRecoveryKey = function (req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            //Sanitation des valeurs reçues.
            ...
            let currentTime = new Date();
            //Validation des valeurs reçues.
            let usr = yield userModel.model.findById(req.params.userId);
            if (!usr ||
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (!"userId" in req.params ||
                ...
                return res.status(400).json("Bad Request");
            //Validation des valeurs reçues.
            let usr = yield userUtils.getUserFromId(req.params.userId);
            ...
            if (!usr ||
                ...
                (currentDate - usr.codeRMDate) / 1000 >
                    parseInt((_a = process.env.PASSWORD_REINIT_CODE_TIMEOUT_SECONDS) !== null && _a !== void 0 ? _a : 600))
                return res.status(401).json("Unauthorized");
            //Execution.
            delete usr.codeRM;
